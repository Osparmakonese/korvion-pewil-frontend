  ...
  return (
    <div style={S.wrapper}>
      ...
      <div style={S.body}>
        ...
        <p style={S.p}>Pewil pricing depends on the module you use. Retail (shop) accounts start with a 14-day free trial, after which a flat monthly subscription applies (Starter, Growth or Enterprise — billed monthly, or yearly with two months free). Farm accounts also receive a 14-day free trial, after which continued access requires a paid subscription. Optional add-ons (such as Pewil AI and Pewil Enterprise) are billed separately as flat monthly subscriptions. Payments are processed securely through Pesepay, supporting Visa, Mastercard, EcoCash, and OneMoney. Fees are billed monthly and are non-refundable except where required by applicable law or at our sole discretion.</p>
