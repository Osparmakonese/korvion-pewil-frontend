  ...
  return (
    <div style={S.wrapper}>
      ...
      <div style={S.body}>
        ...
        <p style={S.p}>Pewil pricing depends on the module you use. Retail (shop) accounts are billed per receipt: the first 1,000 receipts each calendar month are free, with usage-based fees above that, capped at a monthly maximum — there is no upfront charge and no separate trial. Farm accounts receive a 14-day free trial, after which continued access requires a paid subscription. Optional add-ons (such as Pewil AI and Pewil Enterprise) are billed separately as flat monthly subscriptions. Payments are processed securely through Pesepay, supporting Visa, Mastercard, EcoCash, and OneMoney. Fees are billed monthly and are non-refundable except where required by applicable law or at our sole discretion.</p>
