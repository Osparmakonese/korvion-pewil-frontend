        ...
        <div className="pl-wrap pl-nav-in">
          <Link to="/farm" className="pl-brand">
            <svg width="28" height="28" viewBox="0 0 120 120" aria-hidden="true" style={{ display: 'block' }}>
              <defs><linearGradient id="plfMark" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#1a6b3a"/><stop offset="1" stopColor="#2e9e57"/></linearGradient></defs>
              <rect x="6" y="6" width="108" height="108" rx="30" fill="url(#plfMark)"/>
