...
const S = {
  ...
  metricCard: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 10, padding: '16px 18px', position: 'relative', overflow: 'hidden', boxShadow: '0 1px 2px rgba(15,23,18,0.04), 0 12px 28px -18px rgba(15,23,18,0.14)' },
  metricIcon: (bg) => ({ width: 26, height: 26, borderRadius: 8, background: bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, marginBottom: 8 }),
  metricLabel: { fontSize: 10, color: '#6b7280', fontWeight: 500, marginBottom: 2 },
  metricVal: (color) => ({ fontFamily: "'Plus Jakarta Sans', 'Inter', system-ui, sans-serif", fontSize: 22, fontWeight: 700, color, lineHeight: 1.2 }),
  ...
  btnSmall: { padding: '6px 12px', background: '#1a6b3a', color: '#fff', border: 'none', borderRadius: 8, fontSize: 11, fontWeight: 600, cursor: 'pointer' },
  btnSmallSecondary: { padding: '6px 12px', background: '#f3f4f6', color: '#6b7280', border: '1px solid #d1d5db', borderRadius: 8, fontSize: 11, fontWeight: 600, cursor: 'pointer' },
  error: { fontSize: 10, color: '#c0392b', marginTop: 4 },
  sectionTitle: { fontSize: 14, fontWeight: 700, color: '#111827', marginBottom: 10, fontFamily: "'Plus Jakarta Sans', 'Inter', system-ui, sans-serif" },
  loanCard: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 10, padding: 16, marginBottom: 14 },
  ...
  repaymentHistory: { background: '#f6f8f6', borderRadius: 8, padding: 12, marginTop: 12, marginBottom: 12 },
  repaymentItem: { display: 'flex', justifyContent: 'space-between', fontSize: 10, color: '#6b7280', marginBottom: 6, paddingBottom: 6, borderBottom: '1px solid #e3e8e4' },
  repaymentAmount: { fontWeight: 700, color: '#111827' },
  makePaymentForm: { background: '#f6f8f6', borderRadius: 8, padding: 12, marginTop: 12, display: 'grid', gridTemplateColumns: 'auto auto 1fr', gap: 8, alignItems: 'flex-end' },
  paymentInputSmall: { width: 120, padding: '6px 8px', border: '1px solid #e3e8e4', borderRadius: 8, fontSize: 11, outline: 'none', color: '#111827', boxSizing: 'border-box' },
  paymentDateSmall: { width: 130, padding: '6px 8px', border: '1px solid #e3e8e4', borderRadius: 8, fontSize: 11, outline: 'none', color: '#111827', boxSizing: 'border-box' },
};
