...
const s = {
  ...
  title: { fontSize: 22, fontWeight: 700, color: '#111827', fontFamily: "'Plus Jakarta Sans', 'Inter', system-ui, sans-serif", margin: '0 0 6px 0' },
  sub: { fontSize: 12, color: '#6b7280', marginBottom: 16 },
  card: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 12, padding: 20, marginBottom: 16, boxShadow: '0 1px 2px rgba(15,23,18,0.04), 0 12px 28px -18px rgba(15,23,18,0.14)' },
  ...
  th: { textAlign: 'left', padding: '8px 10px', fontSize: 9, fontWeight: 700, color: '#6b7280', textTransform: 'uppercase', background: '#f6f8f6', borderBottom: '1px solid #e3e8e4' },
  td: { padding: '6px 10px', fontSize: 12, borderBottom: '1px solid #e3e8e4' },
  input: { width: '100%', padding: '6px 8px', border: '1px solid #e3e8e4', borderRadius: 8, fontSize: 12, boxSizing: 'border-box' },
  btnPrimary: { padding: '8px 16px', background: '#1a6b3a', color: '#fff', border: 'none', borderRadius: 10, fontSize: 12, fontWeight: 600, cursor: 'pointer' },
  btnGhost: { padding: '6px 12px', background: '#f3f4f6', color: '#374151', border: 'none', borderRadius: 10, fontSize: 11, fontWeight: 600, cursor: 'pointer' },
  btnRed: { padding: '6px 10px', background: '#fff', color: '#c0392b', border: '1px solid #fecaca', borderRadius: 8, fontSize: 11, fontWeight: 600, cursor: 'pointer' },
