      ...
      <div className="lg-grid">
        ...
        <aside className="lg-hero">
          <Link to="/" className="lg-brand">
            <svg width="26" height="26" viewBox="0 0 120 120" aria-hidden="true" style={{ display: 'block' }}>
              <defs><linearGradient id="lgMark" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#1a6b3a"/><stop offset="1" stopColor="#2e9e57"/></linearGradient></defs>
              <rect x="6" y="6" width="108" height="108" rx="30" fill="url(#lgMark)"/>
