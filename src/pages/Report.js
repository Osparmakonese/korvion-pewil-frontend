...
const S = {
  ...
  aiResult: {
    background: '#f6f8f6', borderRadius: 8, padding: 16, marginBottom: 18,
    fontSize: 12, lineHeight: 1.6, color: '#374151', whiteSpace: 'pre-wrap',
    border: '1px solid #e3e8e4',
  },
  twoCol: { display: 'grid', gridTemplateColumns: '1fr 310px', gap: 20 },
  card: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 10, padding: '16px 18px', marginBottom: 14 },
  plCard: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 10, padding: '18px 20px', marginBottom: 14, borderLeft: '4px solid #1a6b3a' },
  overheadCard: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 10, padding: '18px 20px', marginBottom: 14, borderLeft: '4px solid #c97d1a' },
      ...
      <div style={{ ...S.card, borderLeft: '4px solid #1a6b3a' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 10 }}>
          {[
            ...
            <div key={r.type} style={{ border: '1px solid #e3e8e4', borderRadius: 8, padding: 12, background: '#f6f8f6' }}>
              ...
              <div style={{ display: 'flex', gap: 6 }}>
                <button
                  ...
                  style={{ flex: 1, padding: '6px 10px', borderRadius: 8, border: 'none', background: '#c0392b', color: '#fff', fontSize: 10, fontWeight: 700, cursor: 'pointer' }}>
                  {rptBusy === `${r.type}-pdf` ? '...' : 'PDF'}
                </button>
                <button
                  onClick={() => handleDownload(r.type, 'xlsx')}
                  disabled={rptBusy === `${r.type}-xlsx`}
                  style={{ flex: 1, padding: '6px 10px', borderRadius: 8, border: 'none', background: '#1a6b3a', color: '#fff', fontSize: 10, fontWeight: 700, cursor: 'pointer' }}>
        ...
        <div>
          ...
          <div style={S.plCard}>
            ...
            <div style={S.totalRow}>
              ...
              <span style={{ color: net >= 0 ? '#1a6b3a' : '#c0392b', fontFamily: "'Plus Jakarta Sans', 'Inter', system-ui, sans-serif", fontSize: 18 }}>{fmt(net)}</span>
            </div>
          </div>
            ...
            <div style={{ ...S.overheadCard, borderLeftColor: '#6c5ce7' }}>
              ...
              <div style={{ marginTop: 10 }}>
                ...
                <div style={S.totalRow}>
                  ...
                  <span style={{ color: livestockNet >= 0 ? '#1a6b3a' : '#c0392b', fontFamily: "'Plus Jakarta Sans', 'Inter', system-ui, sans-serif", fontSize: 16 }}>{fmt(livestockNet)}</span>
                </div>
              </div>
            </div>
          )}
          ...
          <div style={{ background: '#fff', borderRadius: 10, border: '1px solid #e3e8e4', overflow: 'hidden', marginBottom: 14 }}>
            <div style={{ overflowX: 'auto' }}><table style={S.table}>
              <thead><tr>
        ...
        <div>
          <div style={S.card}>
            ...
            <div style={S.bsSection}>
              ...
              {livestockSalesRev > 0 && <div style={S.row}><span style={S.rowLabel}>Livestock sales</span><span style={S.rowVal('#1a6b3a')}>{fmt(livestockSalesRev)}</span></div>}
              <div style={{ ...S.row, fontWeight: 700, borderBottom: '2px solid #e3e8e4' }}><span>Total Assets</span><span style={{ color: '#1a6b3a' }}>{fmt(totalAssets + livestockSalesRev)}</span></div>
            </div>
            <div style={S.bsSection}>
              ...
              <div style={{ ...S.row, fontWeight: 700, borderBottom: '2px solid #e3e8e4' }}><span>Total Liabilities</span><span style={{ color: '#c0392b' }}>{fmt(totalLiabilities + livestockHealthCosts)}</span></div>
            </div>
