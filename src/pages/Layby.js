...
const S = {
  ...
  stat: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 10, padding: '12px 16px', minWidth: 140 },
  ...
  btnSm: { padding: '5px 9px', borderRadius: 8, fontSize: 11, fontWeight: 700, cursor: 'pointer', border: '1px solid #e2e8f0', background: '#fff', color: '#334155' },
  card: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 12, padding: 4 },
  table: { width: '100%', borderCollapse: 'collapse', fontSize: 12 },
  th: { fontSize: 9, fontWeight: 800, color: '#94a3b8', textTransform: 'uppercase', textAlign: 'left', padding: '10px', borderBottom: '1px solid #e3e8e4' },
  ...
  input: { width: '100%', padding: '9px 11px', border: '1px solid #e2e8f0', borderRadius: 10, fontSize: 13, boxSizing: 'border-box' },
