...
const S = {
  ...
  headerBtn: { background: '#1a6b3a', color: '#fff', border: 'none', padding: '6px 12px', borderRadius: 10, fontSize: 11, fontWeight: 600, cursor: 'pointer' },
  ...
  promoGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 10 },
  promoCard: { border: '1px solid #e3e8e4', borderRadius: 8, padding: 14, borderLeft: '4px solid', position: 'relative' },
  ...
  badge: { display: 'inline-block', fontSize: 10, fontWeight: 700, padding: '2px 7px', borderRadius: 20, textTransform: 'uppercase', marginRight: 6 },
