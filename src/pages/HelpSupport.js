...
const FAQ = [
  ...
  { cat: 'billing', q: 'How does pricing work in Zambia (Kwacha)?', a: 'Zambian shops are billed in Kwacha (K). Monthly plans are Starter K199, Growth K499 (add more shops for K149 each, up to 6), and Enterprise K299 per shop from a minimum of 6 shops. You pay your subscription by MTN, Airtel or Zamtel mobile money — or card — through Lenco, settling to a Zambian bank account. Yearly billing gives you 2 months free.' },
  { cat: 'billing', q: 'Is there a free trial and how does pricing work?', a: 'Yes — every new shop gets a 14-day free trial, no card required. After that, one flat monthly price: Starter $10 for one shop, Growth $25 for two shops with more at $8 each up to 6, and Enterprise $15 per shop from a minimum of 6 (or pay yearly and get 2 months free). Tax-authority fiscalisation and mobile money are included in every plan. Farm has the same 14-day trial on its own tiers. Your data is always preserved.' },
