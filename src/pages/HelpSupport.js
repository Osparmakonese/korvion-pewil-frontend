...
const FAQ = [
  ...
  { cat: 'fiscal', q: 'How do I connect my Zambian shop to ZRA Smart Invoice?', a: 'Register for ZRA Smart Invoice on the ZRA portal to get your TPIN and Smart Invoice device (VSDC) credentials. Then in Pewil open Fiscal / Tax Settings, choose Zambia, and enter your TPIN and device details (start in sandbox). Once registered, every sale is reported to ZRA automatically and the receipt carries the Smart Invoice QR and verification code — the same way ZIMRA works in Zimbabwe.' },
  ...
  { cat: 'billing', q: 'How does pricing work in Zambia (Kwacha)?', a: 'Zambian shops are billed in Kwacha (K), per shop per month: Starter K199, Growth K299, Enterprise K499. You can run as many shops as you like on any plan — each simply adds its own rate. You pay by MTN, Airtel or Zamtel mobile money — or card — through Lenco, settling to a Zambian bank account. Yearly billing gives you 2 months free.' },
  { cat: 'billing', q: 'Is there a free trial and how does pricing work?', a: 'Yes — every new shop gets a 14-day free trial, no card required. After that it is a simple price per shop per month: $10 Starter, $15 Growth, $25 Enterprise (or pay yearly and get 2 months free). You can add as many shops as you like on any plan. What changes between plans is how many cashiers each shop can have — 1, 3, or unlimited. Managers, supervisors and office staff are unlimited on every plan. Tax-authority fiscalisation and mobile money are included throughout.' },
