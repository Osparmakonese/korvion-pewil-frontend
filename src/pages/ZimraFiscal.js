...
const S = {
  ...
  heroTitle: { fontSize: 20, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', 'Inter', system-ui, sans-serif", margin: 0, marginBottom: 4 },
  ...
  stat: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 10, padding: 16, borderLeft: '4px solid #e3e8e4' },
  ...
  card: { background: '#fff', border: '1px solid #e3e8e4', borderRadius: 10, padding: 18 },
  ...
  input: { width: '100%', padding: '10px 12px', border: '1px solid #e3e8e4', borderRadius: 10, fontSize: 13, boxSizing: 'border-box', background: '#f6f8f6', color: '#374151' },
  select: { width: '100%', padding: '10px 12px', border: '1px solid #e3e8e4', borderRadius: 10, fontSize: 13, boxSizing: 'border-box', background: '#fff' },
  btnRow: { display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 6 },
  btn: { padding: '10px 14px', borderRadius: 10, fontSize: 12, fontWeight: 700, cursor: 'pointer', border: 'none' },
  ...
  info: { background: '#f6f8f6', border: '1px solid #e3e8e4', borderRadius: 8, padding: 12, marginTop: 12, fontSize: 11, color: '#6b7280', lineHeight: 1.6 },
  ...
  th: { fontSize: 9, fontWeight: 700, color: '#9ca3af', textTransform: 'uppercase', padding: '8px', borderBottom: '1px solid #e3e8e4', background: '#f6f8f6', textAlign: 'left' },
