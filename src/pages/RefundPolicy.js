  ...
  return (
    <div style={S.wrapper}>
      ...
      <div style={S.body}>
        ...
        <p style={S.p}>Both retail (shop) and farm accounts receive a 14-day free trial, during which no payment is taken. If you cancel before the trial ends, you will never be charged and no refund is required. If an account does not subscribe at the end of its trial — or later leaves an invoice unpaid past the grace period — the account enters a read-only state and you can still export your data.</p>
